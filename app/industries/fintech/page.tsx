...
export default function FintechIndustryPage() {
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-emerald-200 pb-20">
      ...
      <section className="relative pt-32 pb-24 px-6 max-w-7xl mx-auto text-center space-y-8 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-blue-100/50 blur-[120px] rounded-full -z-10"></div>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-[#0A192F] p-8 md:p-12 rounded-[3rem] shadow-2xl relative overflow-hidden border border-slate-800">
             ...
             <div className="space-y-4 relative z-10">
               ...
               <div className="flex justify-center"><ArrowRight className="text-emerald-500 rotate-90" /></div>
               
               {/* Event Stream (Kafka) */}
               <div className="bg-blue-900/30 border border-blue-500/50 p-5 rounded-2xl shadow-[0_0_30px_rgba(59,130,246,0.15)] relative">
               ...
               <div className="flex justify-center"><ArrowRight className="text-emerald-500 rotate-90" /></div>
               {/* Final State */}
               <div className="flex items-center gap-4 bg-emerald-900/20 p-4 rounded-xl border border-emerald-500/30">
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm hover:border-blue-500 transition-colors group">
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="bg-white border border-slate-200 rounded-[3rem] p-8 md:p-16 shadow-xl shadow-slate-100 flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="flex-1 w-full grid grid-cols-2 gap-4">
             <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 flex flex-col justify-center"><h4 className="text-blue-700 font-bold mb-2">High-Concurrency Core</h4><p className="text-slate-600 text-sm">Go (Golang), Rust, Java</p></div>
             <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 flex flex-col justify-center"><h4 className="text-blue-700 font-bold mb-2">Event Streaming</h4><p className="text-slate-600 text-sm">Apache Kafka, RabbitMQ</p></div>
             <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 flex flex-col justify-center"><h4 className="text-blue-700 font-bold mb-2">ACID Compliant DBs</h4><p className="text-slate-600 text-sm">PostgreSQL, CockroachDB</p></div>
             <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 flex flex-col justify-center"><h4 className="text-blue-700 font-bold mb-2">Client Applications</h4><p className="text-slate-600 text-sm">React Native, Next.js</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-[#0A192F] text-white relative overflow-hidden border-y border-slate-800">
        <div className="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 w-full bg-slate-900 border border-slate-700 p-8 rounded-[2rem] shadow-[0_0_40px_rgba(16,185,129,0.1)]">
             ...
             <div className="space-y-4">
               ...
               {/* Flagged Tx */}
               <div className="bg-red-900/20 p-4 rounded-xl border border-red-500/50 flex justify-between items-center shadow-[0_0_20px_rgba(239,68,68,0.15)] relative overflow-hidden">
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          {[
            ...
            <div key={idx} className="p-6 rounded-2xl bg-slate-50 border border-slate-200 shadow-sm hover:border-blue-400 transition-colors relative overflow-hidden group">
