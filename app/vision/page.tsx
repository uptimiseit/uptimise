...
const projects = [
  {
    ...
    impact: "Stable performance across 50+ organizations with 3x faster feature rollout capability.",
  ...
  },
  {
    ...
    problem: "Inefficient manual workflows and fragmented operational data were stalling decision-making for a mid-sized enterprise.",
    solution: "Developed an AI-agent cluster that analyzes incoming data streams and triggers automated business logic via LLM-orchestration.",
    tech: ["Python", "OpenAI API", "Node.js", "LangChain", "GCP"],
    impact: "60% reduction in manual data processing time and 99% accuracy in automated reporting.",
  ...
  },
  {
    ...
    problem: "Requirement for a high-security mobile entry point with real-time data synchronization for digital banking services.",
    solution: "Architected a native-first mobile system using Swift and Kotlin, supported by a scalable Go-based microservices backend.",
    tech: ["Kotlin", "Swift", "Go", "Redis", "Cloud Infra"],
    impact: "Zero-latency transaction updates and a 4.9/5 star user experience rating.",
  ...
  },
  {
    ...
    problem: "Complex vendor management and payment routing bottlenecks across international borders.",
    solution: "Built a distributed marketplace architecture with automated payment splits and a real-time product catalog sync engine.",
    tech: ["Next.js", "MongoDB", "Stripe Connect", "ElasticSearch"],
    impact: "Supporting 5k+ active vendors with seamless sub-second search and global payout logic.",
          ...
          {projects.map((project) => (
            <motion.div 
              ...
              className={`group relative rounded-[3rem] border transition-all duration-500 overflow-hidden ${
                expandedId === project.id ? 'bg-white border-blue-600 shadow-2xl' : 'bg-white border-slate-100 hover:border-slate-300'
              }`}
            >
              {/* Top Bar / Summary */}
              <div 
              ...
              >
                ...
                <div className="flex items-center gap-6 w-full lg:w-auto justify-between lg:justify-end">
                   <div className="flex items-center gap-3">
                      <div className="flex -space-x-2">
                        {project.tech.slice(0, 3).map((t, i) => (
                           <div key={i} className="w-8 h-8 rounded-full bg-slate-100 border-2 border-white flex items-center justify-center text-[8px] font-black font-mono text-slate-400 uppercase">
                             {t[0]}
                           </div>
                        ))}
                      </div>
                   ...
                   <div className="p-3 rounded-full bg-slate-50 group-hover:bg-blue-600 group-hover:text-white transition-all">
                  ...
                  >
                    <div className="p-10 grid grid-cols-1 lg:grid-cols-12 gap-12">
                      ...
                      <div className="lg:col-span-7 space-y-10">
                        ...
                        <div className="p-8 rounded-3xl bg-blue-50 border border-blue-100 flex items-center justify-between group/impact">
                           ...
                           <CheckCircle2 className="text-blue-600 opacity-20 group-hover/impact:opacity-100 transition-opacity" />
                        </div>
                      </div>
                         ...
                         <div className="space-y-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                               {project.tech.map((t, i) => (
                                  <span key={i} className="px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-[10px] font-bold font-mono text-slate-600">
                                    {t}
                                  </span>
                               ))}
                            </div>
