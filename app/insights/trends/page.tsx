...
//       {/* 1. HERO SECTION */}
//       <section className="relative pt-40 pb-16 px-6 max-w-7xl mx-auto text-center space-y-6">
//         <motion.div 
//           initial={{ opacity: 0, scale: 0.8 }}
//           animate={{ opacity: 1, scale: 1 }}
//           className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-50 border border-violet-200 text-violet-800 text-xs font-black tracking-widest uppercase mb-4"
//         >
//           <Radar size={14} className="animate-pulse" /> Industry Radar
//         </motion.div>
        
//         <motion.h1 
//           initial={{ opacity: 0, y: 30 }}
//           animate={{ opacity: 1, y: 0 }}
//           className="text-5xl md:text-7xl font-black tracking-tighter text-slate-900 max-w-4xl mx-auto leading-tight"
//         >
//           The Future <br /> 
//           <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-fuchsia-600 italic">Decoded.</span>
//         </motion.h1>
...
//         >
//           Analyzing market shifts and emerging technologies to help leaders navigate the next decade of digital innovation.
//         </motion.p>
//       </section>
...
//               value={searchQuery}
//               onChange={(e) => setSearchQuery(e.target.value)}
//               className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-12 pr-4 py-3 text-sm font-bold focus:ring-2 focus:ring-violet-500/20 transition-all outline-none"
//             />
//           </div>
...
//                 : "bg-white border border-slate-200 text-slate-500 hover:border-violet-400"
//               }`}
//             >
//               {category}
//             </motion.button>
...
//             viewport={{ once: true }}
//           >
//             <Link href={'/trends/blog-detail'} className="mb-16 group block">
//               <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center bg-white border border-slate-100 rounded-[3.5rem] p-6 lg:p-10 shadow-sm hover:shadow-2xl hover:border-violet-200 transition-all duration-500">
//                 <div className={`w-full h-64 lg:h-96 rounded-[2.5rem] bg-gradient-to-br ${featuredPost.imageGradient} relative overflow-hidden`}>
//                   <motion.div 
//                     animate={{ scale: [1, 1.2, 1], opacity: [0.2, 0.3, 0.2] }}
//                     transition={{ duration: 10, repeat: Infinity }}
//                     className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-20"
//                   />
//                   <div className="absolute top-6 left-6 bg-white/20 backdrop-blur-md text-white px-4 py-1.5 rounded-full text-xs font-black uppercase border border-white/30 flex items-center gap-2">
//                     <div className="w-2 h-2 rounded-full bg-green-400 animate-pulse" />
//                     Live_Analysis
//                   </div>
//                 </div>
//                 <div className="space-y-6 lg:px-6">
//                   <span className="text-[10px] font-black tracking-[0.2em] text-violet-600 uppercase">Sector_Lead_Report</span>
//                   <h2 className="text-3xl lg:text-5xl font-black text-slate-900 group-hover:text-violet-600 transition-colors tracking-tighter leading-none">
//                     {featuredPost.title}
//                   </h2>
...
//                     </div>
//                     <span className="text-violet-600 font-black text-xs uppercase tracking-widest flex items-center gap-2 group-hover:gap-4 transition-all">
...
//                       >
//                         <div className={`${viewMode === "list" ? "w-full md:w-1/3 h-56 md:h-full" : "w-full h-48"} bg-gradient-to-br ${post.imageGradient} relative transition-transform duration-700 group-hover:scale-105`} />
//                         <div className="p-8 flex flex-col flex-1 bg-white">
//                           <div className="flex items-center justify-between mb-4">
//                             <span className="text-[10px] font-black text-fuchsia-600 uppercase tracking-widest bg-fuchsia-50 px-2 py-1 rounded">{post.category}</span>
//                             <span className="text-[10px] font-bold text-slate-400 uppercase font-mono">{post.readTime}</span>
//                           </div>
//                           <h3 className="text-xl font-black text-slate-900 mb-3 group-hover:text-fuchsia-600 transition-colors leading-tight tracking-tight">
//                             {post.title}
//                           </h3>
...
//                             <ArrowRight size={16} className="text-fuchsia-600 group-hover:translate-x-2 transition-transform" />
//                           </div>
//                         </div>
//                       </motion.div>
//                     </Link>
...
//                 <TrendingUp size={14} className="text-fuchsia-600" /> Hot_Topics
//               </h3>
//               <div className="space-y-6">
//                 {popularPosts.map((post, idx) => (
//                   <motion.div whileHover={{ x: 5 }} key={post.id} className="flex gap-4 group cursor-pointer">
//                     <span className="text-2xl font-black text-slate-100 group-hover:text-violet-100 transition-colors font-sans">0{idx + 1}</span>
//                     <div>
//                       <h4 className="font-bold text-slate-800 text-xs group-hover:text-violet-600 transition-colors leading-tight mb-1">
//                         {post.title}
//                       </h4>
...
//             <div className="bg-slate-950 rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden text-white">
//               <motion.div 
//                 animate={{ scale: [1, 1.5, 1], opacity: [0.1, 0.3, 0.1] }} 
//                 transition={{ duration: 6, repeat: Infinity }}
//                 className="absolute -right-10 -bottom-10 w-48 h-48 bg-fuchsia-600 blur-[80px] rounded-full" 
//               />
//               <Sparkles className="text-fuchsia-400 w-8 h-8 mb-4 relative z-10" />
//               <h3 className="text-xl font-black mb-2 relative z-10 uppercase tracking-tighter">The Future, Delivered</h3>
//               <p className="text-slate-400 text-sm font-medium leading-relaxed mb-6 relative z-10">
//                 Monthly strategic briefings on the tech that matters.
//               </p>
//               <form className="relative z-10 space-y-3">
//                 <input 
//                   type="email" 
//                   placeholder="name@future.com" 
//                   className="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 text-xs text-white placeholder:text-slate-600 font-mono focus:ring-2 focus:ring-fuchsia-500 outline-none transition-all"
//                 />
//                 <motion.button 
//                   whileHover={{ scale: 1.02 }}
//                   whileTap={{ scale: 0.98 }}
//                   className="w-full bg-violet-600 text-white font-black uppercase tracking-widest text-[10px] rounded-xl py-4 shadow-lg shadow-violet-900/40"
//                 >
//                   Join_Radar_Feed
//                 </motion.button>
//               </form>
...
import { 
  Search, LayoutGrid, List as ListIcon, 
  ArrowRight, Clock, Calendar, TrendingUp, 
  Sparkles, Radar, Loader2, AlertCircle
} from "lucide-react";

export default function TechTrendsBlogPage() {
  const [viewMode, setViewMode] = useState<"grid" | "list">("grid");
  const [activeSubCategory, setActiveSubCategory] = useState("All Trends");
  const [searchQuery, setSearchQuery] = useState("");
  
  // --- API DATA STATE ---
  const [allPosts, setAllPosts] = useState<any[]>([]);
  const [subCategories, setSubCategories] = useState<string[]>(["All Trends"]);
    ...
    const fetchTechTrends = async () => {
      try {
        ...
        if (json.success && Array.isArray(json.data)) {
          // Filter ONLY blogs where category is exactly "Tech Trends"
          const trendBlogs = json.data.filter(
            (post: any) => post.category?.trim() === "Tech Trends"
          );

          setAllPosts(trendBlogs);

          // Extract unique sub-categories dynamically
          ...
          setSubCategories(["All Trends", ...uniqueSubCats]);
        }
      } catch (err: any) {
        console.error("Fetch Error:", err);
        setError("Failed to sync with the Industry Radar. Please check your connection.");
      } finally {
        setIsLoading(false);
      }
    };
  ...
  const filteredPosts = allPosts.filter(post => {
    const matchesSubCategory = activeSubCategory === "All Trends" || post.subCategory === activeSubCategory;
    const matchesSearch = post.title.toLowerCase().includes(searchQuery.toLowerCase());
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#FDFDFF]">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-xs font-bold text-slate-400 uppercase tracking-[0.3em] font-mono">Scanning_Radar...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#FDFDFF] text-slate-900 font-sans pb-20 overflow-hidden">
      ...
      <section className="relative pt-40 pb-16 px-6 max-w-7xl mx-auto text-center space-y-6">
        <motion.div 
          initial={{ opacity: 0, scale: 0.8 }}
          animate={{ opacity: 1, scale: 1 }}
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-50 border border-violet-200 text-violet-800 text-[10px] font-black tracking-widest uppercase mb-4"
        >
          <Radar size={14} className="animate-pulse" /> Industry Radar
        </motion.div>
        ...
        <motion.h1 
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          className="text-5xl md:text-7xl font-black tracking-tighter text-slate-900 max-w-4xl mx-auto leading-[0.95]"
        >
          The Future <br /> 
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-fuchsia-600 italic">Decoded.</span>
        </motion.h1>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
              ...
              <AnimatePresence mode="popLayout">
                {filteredPosts.length > 0 ? (
                        ...
                        >
                          <div className={`${viewMode === "list" ? "w-full md:w-1/3 h-56 md:h-full" : "w-full h-48"} bg-slate-100 relative overflow-hidden`}>
                             {post.featuredImage ? (
                               ...
                               <div className="w-full h-full bg-gradient-to-br from-violet-400 to-fuchsia-600 flex items-center justify-center text-white/20 font-bold text-2xl uppercase tracking-tighter">Radar</div>
                             )}
                             <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-md text-violet-800 px-3 py-1 rounded-full text-[10px] font-black border border-violet-100 shadow-sm uppercase tracking-widest">
                               ANALYSIS
                             </div>
                          </div>
                          ...
                          <div className="p-8 flex flex-col flex-1 bg-white">
                            <div className="flex items-center justify-between mb-4">
                              <span className="text-[10px] font-black text-fuchsia-600 uppercase tracking-widest bg-fuchsia-50 px-2 py-1 rounded">
                                {post.subCategory || "Emerging"}
                              </span>
                  ...
                  <div className="col-span-full py-24 text-center border-2 border-dashed border-slate-200 rounded-[3rem]">
                    <p className="text-slate-400 font-bold uppercase tracking-widest text-xs">No signals found on this frequency.</p>
                  </div>
                )}
              </AnimatePresence>
            </motion.div>
          ...
          <div className="lg:col-span-4 space-y-10">
            <div className="bg-white border border-slate-100 rounded-[2.5rem] p-8 shadow-sm">
              <h3 className="text-xs font-black text-slate-900 mb-6 flex items-center gap-2 uppercase tracking-[0.2em]">
                <TrendingUp size={14} className="text-fuchsia-600" /> Hot_Nodes
              </h3>
              <div className="space-y-6">
                {popularPosts.map((post, idx) => (
                  <Link key={post.id} href={`/blog/${post.slug}`} className="flex gap-4 group cursor-pointer items-start">
                    <span className="text-2xl font-black text-slate-100 group-hover:text-violet-200 transition-colors font-sans">0{idx + 1}</span>
                    <div>
                      <h4 className="font-bold text-slate-800 text-xs group-hover:text-violet-600 transition-colors leading-tight mb-1">
                        {post.title}
                      </h4>
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">{post.subCategory || "Trend"}</p>
                    </div>
                  </Link>
                ))}
              </div>
            ...
            <div className="bg-slate-950 rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden text-white">
              ...
              />
              <Sparkles className="text-fuchsia-400 w-8 h-8 mb-4 relative z-10" />
              <h3 className="text-xl font-black mb-2 relative z-10 uppercase tracking-tighter leading-tight">The Future, <br />Delivered.</h3>
              <p className="text-slate-400 text-sm font-medium leading-relaxed mb-6 relative z-10">
                Monthly strategic briefings on the tech signals that matter.
              </p>
              <form className="relative z-10 space-y-3">
                <input 
                  type="email" 
