      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-end mb-20 gap-8">
          <div className="max-w-2xl space-y-6 text-left">
            ...
            <p className="text-xl text-slate-500 font-body leading-relaxed max-w-xl">
              ...
              >
                ...
                <div className="space-y-6 relative z-10">
                  ...
                  <div className="space-y-4">
                    ...
                    <h3 className="text-2xl font-black font-header text-slate-950 leading-tight group-hover:text-blue-600 transition-colors">
                      {post.title}
                    </h3>
                  </div>
                </div>

                <div className="mt-12 flex items-center gap-2 text-[10px] font-black font-mono text-slate-400 group-hover:text-blue-600 transition-colors uppercase tracking-widest">
