    ...
    <section className="relative bg-white py-10 px-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-end mb-10 gap-8">
          ...
          <p className="text-sm text-slate-500 font-body max-w-[280px] lg:text-right pb-4 leading-relaxed">
            Deploying AI-native engineering excellence across high-stakes global markets.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {industries.map((item, i) => (
            <motion.div
              ...
              className={`p-10 rounded-[3rem] border transition-all duration-500 group relative flex flex-col justify-between h-[320px] overflow-hidden ${
                item.featured 
                ? 'bg-[#020617] border-slate-800 text-white lg:col-span-2' 
                : 'bg-slate-50 border-slate-100 hover:bg-white hover:border-blue-500/20 hover:shadow-2xl hover:shadow-blue-100/30'
              }`}
            >
              {/* Background Accent for Hover */}
              ...
              <div className="space-y-6 relative z-10">
                ...
                <div className="space-y-3">
                  ...
                  <p className={`text-sm font-body leading-relaxed max-w-[240px] ${item.featured ? 'text-slate-400' : 'text-slate-500'}`}>
                    {item.desc}
                  </p>
                </div>
              </div>
              ...
              <div className="relative z-10 flex justify-end">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all border ${
                  item.featured ? 'bg-white/5 border-white/10 text-white hover:bg-white hover:text-slate-950' : 'bg-white border-slate-100 text-slate-300 group-hover:bg-blue-600 group-hover:text-white'
                }`}>
                  <ArrowUpRight size={20} />
                </div>
              </div>
