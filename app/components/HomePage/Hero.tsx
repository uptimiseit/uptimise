...
//       <div className="max-w-[1400px] mx-auto px-6 lg:px-16 relative z-10 w-full py-16">
//         <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          
//           {/* LEFT: The 3D Canvas Visual */}
//           <div className="order-2 lg:order-1 relative w-full aspect-square flex items-center justify-center">
//              {/* The canvas component handles its own internal sizing */}
//              <HeroCanvas />
//           </div>
...
//               Uptimise IT combines orchestrated AI agents and elite engineers 
//               to build digital products with <span className="text-slate-900 font-medium">mathematical precision</span>.
//             </p>

//             <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-5">
//               <MovingBorderButton className="h-14 px-12 text-base font-semibold">
//                 Start Your Project
//               </MovingBorderButton>
//               <button className="h-14 px-10 text-base font-semibold text-slate-700 border border-slate-200 rounded-full hover:bg-slate-50 transition-all">
//                 Schedule Call
//               </button>
//             </div>
//           </div>
