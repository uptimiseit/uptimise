...
export default function Hero() {
  ...
  // Check window size to selectively render heavy animations
  useEffect(() => {
  ...
  return (
    <section className="relative w-full min-h-screen lg:min-h-[90vh] overflow-hidden flex items-center py-16 lg:py-28 bg-white">
      ...
      {/* BACKGROUND LAYER GROUP - Disabled on Mobile for Performance */}
      {isDesktop && (
        ...
        <div className="flex flex-col gap-8 text-center">
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/contact" className="w-full sm:w-auto">
              <button aria-label="Start Project" className="w-full sm:w-auto px-10 py-4 bg-blue-600 text-white rounded-full font-bold uppercase text-[10px] tracking-widest shadow-lg hover:bg-blue-500 transition-all active:scale-95">
                Start your project
              </button>
            </Link>

            <Link href="/Explore100x" className="w-full sm:w-auto">
              <button aria-label="Explore" className="w-full sm:w-auto px-10 py-4 border border-blue-600/20 text-blue-800 rounded-full font-bold uppercase text-[10px] tracking-widest hover:bg-blue-50 transition-all active:scale-95">
                Explore 100x Engineering
              </button>
            </Link>
          </div>
