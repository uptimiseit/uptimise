        ...
        <motion.div 
         className="flex flex-col md:flex-row justify-between items-center md:items-end gap-6 border-b border-slate-800/50 pb-10 mb-10">
          <div className="space-y-4">
            ...
            <h2 className="text-4xl md:text-6xl font-black font-header tracking-tighter text-white uppercase leading-none">
              Tech <span className="text-blue-500 italic">DNA.</span>
            </h2>
          </div>
                ...
                <div className="flex flex-wrap justify-center gap-3">
                  {activeTab.techs.map((t, i) => (
                    <motion.span 
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: i * 0.1 }}
                      className="px-6 py-3 bg-slate-800/50 border border-slate-700 rounded-2xl text-xs font-bold text-slate-200 uppercase tracking-widest hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all cursor-default shadow-lg"
                    >
                      {t}
                    </motion.span>
                  ))}
