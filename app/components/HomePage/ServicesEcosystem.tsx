        ...
        >
          {serviceGroups.map((group, i) => (
            <motion.div
              ...
              className={`relative p-8 rounded-[2.5rem] bg-gradient-to-br ${group.color} border border-slate-100 flex flex-col justify-between group transition-shadow duration-500 hover:shadow-2xl hover:shadow-blue-200/30 overflow-hidden ${i === 0 ? 'lg:col-span-2' : ''}`}
            >
