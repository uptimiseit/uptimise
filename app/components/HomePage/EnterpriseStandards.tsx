        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6 relative z-10">
              ...
              <div className="pt-6 border-t border-white/10 flex items-center justify-between">
                <div className="space-y-1">
                    <p className="text-[11px] font-mono text-slate-500 uppercase tracking-widest">Uptime Score</p>
                    <p className="text-xl font-black text-blue-400 font-mono">99.99%</p>
                </div>
                <div className="space-y-1 text-right">
                    <p className="text-[11px] font-mono text-slate-500 uppercase tracking-widest">Fail-Safe</p>
          ...
          >
            <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <span className="text-[11px] font-black text-blue-600 uppercase tracking-[0.2em] font-mono">Global_Latency_Report</span>
                </div>
                <h3 className="text-2xl font-black text-slate-950 mb-2 uppercase tracking-tighter">Deployed Globally.</h3>
                <p className="text-xs text-slate-600 font-medium leading-relaxed mb-6">Automatic edge distribution across 32+ data centers.</p>
                <div className="space-y-2">
                    {['US_EAST_1', 'EU_WEST_2', 'AP_SOUTH_1'].map((region, idx) => (
                        ...
                        >
                            <span>{region}</span>
                            <span className="text-emerald-600 uppercase">Optimized</span>
                        </div>
                    ))}
                </div>
            </div>
          ...
          >
             <div className="relative z-10">
                ...
                <h3 className="text-2xl font-black text-slate-950 mb-2 tracking-tighter uppercase">IP & Compliance.</h3>
                <p className="text-xs text-slate-600 font-medium leading-relaxed">Total code ownership and legal framework adherence.</p>
             </div>
             <div className="mt-8 space-y-2 relative z-10">
                ...
                <div className="flex items-center justify-between text-[11px] font-black font-mono text-slate-600 tracking-widest uppercase py-3 border-b border-slate-200/50">
                   <span>GDPR / SOC2</span>
                   <span className="text-blue-700 flex items-center gap-1"><CheckCircle2 size={12} strokeWidth={3}/> Compliant</span>
                </div>
                <div className="flex items-center justify-between text-[11px] font-black font-mono text-slate-600 tracking-widest uppercase py-3">
                   ...
                   <span className="text-blue-700 flex items-center gap-1"><CheckCircle2 size={12} strokeWidth={3}/> 100% Secure</span>
                </div>
             </div>
          </motion.div>
