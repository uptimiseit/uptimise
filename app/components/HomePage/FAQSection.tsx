...
//             <motion.p 
//             // variants={fadeInUp}
//              className="text-lg text-slate-300 font-medium leading-relaxed max-w-sm">
...
//                 className="p-8 rounded-[2.5rem] bg-sky-800 text-white relative overflow-hidden group shadow-2xl"
//               >
