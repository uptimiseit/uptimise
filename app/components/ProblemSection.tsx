...
const ProblemSection = () => {
  ...
  return (
    <section className="relative bg-white py-16 md:py-28 px-4 sm:px-6 overflow-hidden">
      {/* Background Tech-Grid */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808008_1px,transparent_1px),linear-gradient(to_bottom,#80808008_1px,transparent_1px)] bg-[size:32px_32px]" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div
            ...
            variants={containerVariants}
          >
            {/* Optimized responsive heading line breaks */}
            <motion.h2
              variants={itemVariants}
              className="text-3xl sm:text-4xl md:text-5xl font-black font-header tracking-normal text-slate-900 leading-tight mb-8 lg:mb-10"
            >
              Traditional <br className="hidden sm:inline" />
              Development <br />
              <span className="text-slate-300">Is Obsolete.</span>
            </motion.h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <motion.div
                variants={itemVariants}
                whileHover={{ y: -5 }}
                className="p-6 bg-white border border-slate-100 rounded-3xl shadow-xl shadow-slate-200/40 space-y-4 sm:mt-8"
              >
                <div className="flex justify-between items-start">
                  <ShieldAlert className="text-orange-500" size={24} />
                  <div className="h-2 w-2 rounded-full bg-orange-500 animate-pulse" />
              ...
              <motion.div
                variants={itemVariants}
                whileHover={{ y: -5 }}
                className="p-6 bg-slate-900 rounded-3xl space-y-4 sm:-mt-4 text-white shadow-2xl"
              >
                <ZapOff className="text-blue-400" size={24} />
                <h3 className="font-bold">Zero Agility</h3>
                <p className="text-xs text-slate-400 font-body leading-relaxed">
            ...
            {/* OVERLAY: Timeline Delay Alert (Centered smoothly across viewports) */}
            <motion.div
              variants={alertVariants}
              animate={{
                x: ["-50%", "-49.5%", "-50.5%", "-50%"],
              ...
              transition={{ repeat: Infinity, duration: 4 }}
              className="absolute top-1/2 left-1/2 w-[90%] max-w-[280px] bg-white border-2 border-red-500 p-4 sm:p-5 rounded-2xl shadow-[0_20px_50px_rgba(239,68,68,0.3)] z-20"
            >
              <div className="flex items-center gap-3 text-red-600">
                <AlertCircle size={24} className="shrink-0 animate-pulse" />
                <div>
                  <p className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest leading-none mb-1">
                    Timeline Risk Detected
                  </p>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8, delay: 0.4 }}
            className="space-y-8 lg:space-y-10 order-2 lg:order-2"
          >
            <div className="space-y-4">
              <span className="text-blue-600 font-mono text-xs sm:text-sm font-bold tracking-widest uppercase italic">
                # The Friction Analysis
              </span>
            </div>

            <div className="space-y-6 text-base sm:text-lg md:text-xl text-slate-600 font-body leading-relaxed">
              <p className="text-slate-950 font-bold border-l-4 border-red-500 pl-4 sm:pl-6">
                Legacy agencies rely on{" "}
                <span className="text-red-600 underline decoration-2 underline-offset-4">
                  Big Teams
                </span>{" "}
            ...
            {/* The Pivot to Solution */}
            <Link href={"/solutions/ai-factory"} className="block">
              <motion.div
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="group cursor-pointer bg-slate-50 p-6 sm:p-8 rounded-[2rem] sm:rounded-[2.5rem] border border-slate-100 hover:border-blue-500 hover:bg-white hover:shadow-xl transition-all duration-300"
              >
                <p className="text-[10px] font-black text-blue-600 uppercase tracking-[0.2em] mb-3 sm:mb-4">
                  Transition to Velocity
                </p>
                <div className="flex flex-row items-center justify-between gap-4 sm:gap-6">
                  <h4 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-black font-header text-slate-950 tracking-tight leading-tight">
                    Deploy the AI-Native <br />
                    Software Factory.
                  </h4>
                  <div className="shrink-0 w-10 h-10 sm:w-14 sm:h-14 rounded-full bg-white border border-slate-200 flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition-all shadow-sm">
