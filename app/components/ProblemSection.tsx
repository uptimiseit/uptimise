          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <p className="text-xs text-slate-500 font-body leading-relaxed">Massive overhead with diminishing returns on output.</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-xs text-slate-500 font-body leading-relaxed">Manual workflows lead to inconsistent code and security risks.</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-xs text-slate-400 font-body leading-relaxed">Rigid structures that can't pivot to market demands.</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-xs text-slate-500 font-body leading-relaxed">Weeks spent on boilerplate that AI handles in seconds.</p>
              </motion.div>
            </div>
            ...
            >
              <div className="flex items-center gap-3 text-red-600">
                ...
                <div>
                  <p className="text-[10px] font-black uppercase tracking-widest leading-none mb-1">Timeline Risk Detected</p>
                  <p className="text-base font-bold">Delivery Delay: +12 Weeks</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
